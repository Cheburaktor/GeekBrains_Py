...
# }
goods = []
while input("Вы хотите добавить товар? Введите y/n: ") == 'y':
    number = int(input("Введите номер товара: "))
    features = {}
    while input("Вы хотите добавить параметры продукта? Введите y/n: ") == 'y':
        feature_key = input("Введите новый продукт: ")
        feature_value = input("Введите цену нового продукта: ")
